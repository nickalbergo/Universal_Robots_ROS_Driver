...
class RobotiqGripper:
    ...
    # shortcuts to just open/close with max values
    def quick_open(self):
        self.move(self._min_position, self._max_speed, self._max_force)

    def quick_close(self):
        self.move(self._max_position, self._max_speed, self._max_force)

    # same but wait
    def open(self):
        self.move_and_wait_for_pos(self._min_position, self._max_speed, self._max_force)

    def close(self):
        self.move_and_wait_for_pos(self._max_position, self._max_speed, self._max_force)

    # open/close
    def quick_pinch(self):
        self.quick_open()
        self.quick_close()
